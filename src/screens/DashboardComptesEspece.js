...
const DashboardComptesEspece = ({navigation}) => {
  ...
  const goToDashboardComptesTitre = () => {
    navigation.navigate('DashboardCmptTitre');
  };
    ...
    <SafeAreaView style={{flex: 1, backgroundColor: '#fafcff'}}>
      <LinearGradient colors={['#519342', '#6ec65a']} style={styles.header}>
        ...
        <View style={styles.secondRow}>
          ...
          <TouchableOpacity
            style={styles.buttonTitre}
            onPress={goToDashboardComptesTitre}>
            ...
            {item.data.map((subItem, index) => (
              <View key={index} style={styles.card}>
                ...
                <View style={styles.cardColumn}>
                  ...
                  <Text style={styles.boldText}>{subItem.currentBalance}</Text>
                </View>
              </View>
            ))}
          </View>
